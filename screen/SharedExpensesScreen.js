...
function SharedExpensesScreen({ navigation }) {
  ...
  useEffect(() => {
    if (sharedExpenses === undefined) {
      ...
      setTotalPercentage(sharedExpenses.reduce((acc, cur) => acc + +cur.percentage, 0));
      console.log("Total shared cost: " + +totalCost);
      console.log("Total shared percentage: " + +totalPercentage);
    }
  }, [sharedExpenses]);
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <SharedExpensesCard sharedExpensesTotal={totalCost} sharedPercentageTotal={totalPercentage/100}/>
      <FlatList
        data={sharedExpenses}
        renderItem={(itemData) => {
          ...
          return itemData.item === undefined ? (
            ...
            <ExpensesCard
              ...
              percentage={itemData.item.percentage}
